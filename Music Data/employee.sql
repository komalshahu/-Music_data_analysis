CREATE TABLE IF NOT EXISTS `employee` (
    ...
    `first_name` VARCHAR(8) CHARACTER SET utf8,
    `title` VARCHAR(22) CHARACTER SET utf8,
    `reports_to` INT,
    `levels` VARCHAR(2) CHARACTER SET utf8,
    `birthdate` DATETIME,
    `hire_date` DATETIME,
    `address` VARCHAR(27) CHARACTER SET utf8,
    ...
    `phone` VARCHAR(17) CHARACTER SET utf8,
    `fax` VARCHAR(17) CHARACTER SET utf8,
