CREATE TABLE IF NOT EXISTS `customer` (
    ...
    `company` VARCHAR(48) CHARACTER SET utf8,
    `address` VARCHAR(40) CHARACTER SET utf8,
    `city` VARCHAR(19) CHARACTER SET utf8,
    `state` VARCHAR(6) CHARACTER SET utf8,
    `country` VARCHAR(14) CHARACTER SET utf8,
    `postal_code` VARCHAR(10) CHARACTER SET utf8,
    `phone` VARCHAR(19) CHARACTER SET utf8,
    `fax` VARCHAR(18) CHARACTER SET utf8,
    `email` VARCHAR(29) CHARACTER SET utf8,
    `support_rep_id` INT
);
INSERT INTO `customer` VALUES (1,'Luís','Gonçalves','Embraer-Empresa Brasileira de Aeronautica S.A.','Av. Brigadeiro Faria Lima, 2170','Sao Jose dos Campos','SP','Brazil','12227-000','+55 (12) 3923-5555','+55 (12) 3923-5566','luisg@embraer.com.br',3),
	...
	(44,'Terhi','Hamalainen',NULL,'Porthaninkatu 9','Helsinki',NULL,'Finland','530','+358 09 870 2000',NULL,'terhi.hamalainen@apple.fi',3),
	...
	(49,'Stanislaw','Wójcik',NULL,'Ordynacka 10','Warsaw',NULL,'Poland','00-358','+48 22 828 37 39',NULL,'stanisław.wójcik@wp.pl',4),
